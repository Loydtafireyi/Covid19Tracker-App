...
@section('seo')
    <title>Zimbabwe Covid19 | Cases Tracker</title>
...
<div class="row">
    <div class="col-lg-6">
        <div class="card-box">
            ...
            <div class="map">
                  <svg baseprofile="tiny" stroke="#ffffff" fill="rgb(113, 182, 249)" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" version="1.2" viewbox="0 0 1000 918" xmlns="http://www.w3.org/2000/svg">
                     <g id="ZWE524">
